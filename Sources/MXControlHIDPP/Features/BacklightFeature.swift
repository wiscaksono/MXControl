...
public enum BacklightFeature {

    /// Feature IDs — probe 0x1983 first (v3), fall back to 0x1982 (v2).
    public static let featureIdV3: UInt16 = 0x1983
    public static let featureIdV2: UInt16 = 0x1982

    // MARK: - Backlight Mode (0x1982)

    /// Backlight operating mode from the options byte.
    public enum BacklightMode: Int, Sendable {
        case off = 0
        case automatic = 1
    ...
    public struct BacklightConfig: Sendable {
        /// Master enabled flag.
    ...
    public static func setBacklightConfig(
        transport: HIDTransport,
        deviceIndex: UInt8,
        featureIndex: UInt8,
        featureId: UInt16,
    ...
    public static func getBacklightLevelCount(
        transport: HIDTransport,
        deviceIndex: UInt8,
        featureIndex: UInt8
    ) async throws -> Int {
