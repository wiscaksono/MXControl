...
enum DeviceDescriptors {
    ...
    static func generic(kind: DeviceNameFeature.DeviceKind, name: String) -> DeviceDescriptor {
        ...
        return DeviceDescriptor(
            ...
            nameMatches: [],
            capabilities: [
                DeviceCapability(id: CapabilityID.battery, featureId: BatteryFeature.featureId, label: "Battery", subtitle: nil, kind: .toggle, advanced: false),
                DeviceCapability(id: CapabilityID.hosts, featureId: ChangeHostFeature.featureId, label: "Easy-Switch", subtitle: nil, kind: .toggle, advanced: false),
            ],
            scroll: nil,
            thumbGesture: nil,
            micMute: nil
    ...
    static let mxMaster3S = DeviceDescriptor(
        ...
        type: .mouse,
        pids: [0xB034],
        nameMatches: ["MX Master 3S", "MX Master"],
        capabilities: [
            DeviceCapability(id: CapabilityID.battery, featureId: BatteryFeature.featureId, label: "Battery", subtitle: nil, kind: .toggle, advanced: false),
    ...
    static let mxKeysMini = DeviceDescriptor(
        ...
        type: .keyboard,
        pids: [0xB369],
        nameMatches: ["MX Keys Mini", "MX Keys"],
        capabilities: [
            DeviceCapability(id: CapabilityID.battery, featureId: BatteryFeature.featureId, label: "Battery", subtitle: nil, kind: .toggle, advanced: false),
