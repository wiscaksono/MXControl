...
public final class BLEScanner: NSObject, @unchecked Sendable {
    ...
    nonisolated(unsafe) public static let logiServiceUUID = CBUUID(string: "00010000-0000-1000-8000-011F2000046D")

    // MARK: - Callbacks

    /// Called when a Logitech peripheral is connected. DeviceManager creates a BLEInfoService.
    public var onPeripheralConnected: ((_ peripheral: CBPeripheral, _ name: String) -> Void)?

    /// Called when a peripheral disconnects.
    public var onPeripheralDisconnected: ((_ peripheralId: UUID, _ name: String) -> Void)?
