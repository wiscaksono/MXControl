...
public struct BLEPeripheralInfo: Sendable {
    public var name: String
    public var peripheralId: UUID
    public var batteryLevel: Int?         // 0-100 from Battery Service
    public var manufacturer: String?      // from Device Information Service
...
public final class BLEInfoService: NSObject, CBPeripheralDelegate, @unchecked Sendable {
    ...
    public var onUpdate: ((_ info: BLEPeripheralInfo) -> Void)?
    ...
    public func open() async throws -> BLEPeripheralInfo {
