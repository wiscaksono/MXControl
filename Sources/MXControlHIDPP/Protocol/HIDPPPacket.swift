...
public enum ReportID: UInt8, Sendable {
    ...
    public static func select(forParamCount count: Int) -> ReportID {
...
public struct HIDPPRequest: Sendable {
...
public struct HIDPPResponse: Sendable {
    ...
    public var isHidpp10Error: Bool {
        featureIndex == 0x8F
    }
    ...
    public var errorFeatureIndex: UInt8? {
    ...
    public static func parse(_ data: [UInt8]) -> HIDPPResponse? {
    ...
    public static func parse(_ data: Data) -> HIDPPResponse? {
        parse([UInt8](data))
    }
}
