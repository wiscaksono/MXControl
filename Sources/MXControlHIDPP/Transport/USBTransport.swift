...
private struct ResponseWaiter: Sendable {
    ...
    public let continuation: CheckedContinuation<HIDPPResponse, any Error>
}

// MARK: - IOKit Device Info

/// Metadata about a matched IOKit HID++ device.
public struct IOKitDeviceInfo: Sendable {
    public let uid: String
    public let pid: Int
    public let name: String
    public let transport: TransportType  // .usb or .ble
...
public final class USBTransport: HIDTransport, @unchecked Sendable {
    ...
    public static let hidppUsagePage: Int = 0xFF00
    public static let hidppUsage: Int = 0x0001

    /// BLE direct device HID++ interface
    public static let bleHidppUsagePage: Int = 0xFF43
    public static let bleHidppUsage: Int = 0x0202
    ...
    public var onReceiverMatched: (@Sendable (IOKitDeviceInfo) -> Void)?
    ...
    public var onBLEDeviceMatched: (@Sendable (IOKitDeviceInfo) -> Void)?

    /// Called when a device is physically removed. Provides the UID and info of the removed device.
    public var onDeviceRemoved: (@Sendable (IOKitDeviceInfo) -> Void)?
    ...
    public var notificationHandler: (@Sendable (String, UInt8, UInt8, UInt8, [UInt8]) -> Void)?
    ...
    public var onBLEDeviceOpened: (@Sendable (IOKitDeviceInfo) -> Void)?
    ...
    public var onBLEDeviceReconnected: (@Sendable (String) -> Void)?
    ...
    public func resetNotifiedBLEDevices() {
        stateQueue.sync {
    ...
    public static func productId(of device: IOHIDDevice) -> Int {
        IOHIDDeviceGetProperty(device, kIOHIDProductIDKey as CFString) as? Int ?? 0
    }

    /// Get the product name from a matched device.
    public static func productName(of device: IOHIDDevice) -> String {
